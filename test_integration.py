...
def test_template_manager():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert set(placeholders) == set(expected), f"Placeholders mismatch: got {placeholders}, expected {expected}"
...
def test_data_handler():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert created_template is not None, "Created template not found in template manager"
